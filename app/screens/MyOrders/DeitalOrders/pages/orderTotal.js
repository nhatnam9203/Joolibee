...
export default function orderTotal() {
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <Text style={[AppStyles.fonts.textBold, styles.txtFontSize]}>Tổng cộng:</Text>
                <Text style={[AppStyles.fonts.textBold, styles.txtFontSize]}>215.000 đ</Text>
            </View>
...
const PaymentMethod = () => (
    <View style={[styles.content, { justifyContent: 'flex-end',marginBottom:25 }]}>
