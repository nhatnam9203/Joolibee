    ...
    return (
        ...
        >
            <View style={styles.containerTop}>
                <Text style={[AppStyles.fonts.title, { color: AppStyles.colors.text, fontSize: scaleWidth(32) }]}>Bán Chạy
                </Text>

                <Text style={[AppStyles.fonts.medium, styles.txtMenu, { color: AppStyles.colors.text }]}>XEM THỰC ĐƠN
                </Text>
            </View>
